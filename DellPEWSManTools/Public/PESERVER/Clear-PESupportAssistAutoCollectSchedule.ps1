<#
Clear-PESupportAssistAutoCollectSchedule.ps1 - Clear collection schedule.
...
#>
function Clear-PESupportAssistAutoCollectSchedule
{
  ...
  Process
  {
      $cmdresponse = Invoke-CimMethod -InputObject $instance -MethodName SupportAssistClearAutoCollectSchedule -CimSession $iDRACSession -Arguments $Parameters
      return $cmdresponse
  }
}
