<#
Get-PESupportAssistEULAStatus.ps1 - Accept EULA terms and conditions required for support assist registration and running supportassistcollection.
...
#>
function Get-PESupportAssistEULAStatus
{
    ...
    Process
    {
        $cmdresponse = Invoke-CimMethod -InputObject $instance -MethodName SupportAssistGetEULAStatus -CimSession $iDRACSession
        return $cmdresponse
    }
}
