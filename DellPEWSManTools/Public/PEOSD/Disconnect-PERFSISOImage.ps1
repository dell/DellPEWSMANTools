<#
Disconnect-PERFSISOImage.ps1 - disconnect a remote file share ISO image to PE DRAC.
...
function Disconnect-PERFSISOImage
{
    [CmdletBinding()]
    param (
        [Parameter(Mandatory)]
    ...
    Process
    {
        Invoke-CimMethod -InputObject $instance -CimSession $iDRACSession -MethodName DisconnectRFSISOImage
    }
}
